...
import Visacard from './imgs/visa.jpeg'
import discover from './imgs/discover.jpeg'
import paypol from './imgs/paypol.jpeg'
import americanexpress from './imgs/americanexpress.jpeg'
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12">
          <div className="col-span-1">
            ...
            <p className="text-sm text-gray-600 mb-8">
              Hostrever proudly provides web hosting to over 40,000 customers with 99.9% uptime to over 750,000
              websites.
            </p>
