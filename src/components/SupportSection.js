        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <svg className="w-12 h-12 text-red-600 mb-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">Chat with us 24/7 for quick support.</p>
              <button className="w-full border border-red-600 text-red-600 py-2 rounded-md hover:bg-red-50 transition-colors">
                Chat Now
              </button>
            </div>
